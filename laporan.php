    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 text-sm font-semibold uppercase">Rata-rata</p>
                        <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo $avg_time['avg_days'] ? round($avg_time['avg_days']) : 0; ?> hari</p>
                    </div>
                    <i class="fas fa-hourglass-half text-purple-600 text-3xl"></i>
                </div>
            </div>
        </div>
